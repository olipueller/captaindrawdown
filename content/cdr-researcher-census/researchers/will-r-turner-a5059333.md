...
date: 2026-07-11T12:53:39.977545
...
6. **Cation Release Dynamics in Basalt-Amended Soils: Implications for Enhanced Rock Weathering** (2025)
   0 citations · Enhanced Weathering
...
8. **Validating geochemical models for enhanced rock weathering: an assessment of model inputs and comparability of model results to experimental data** (2023)
   0 citations · Enhanced Weathering

9. **Preliminary findings from comparison of in-situ measurements of enhanced weathering proxies with model predictions** (2023)
   0 citations · Enhanced Weathering

10. **Irrecoverable Carbon: The places we must protect to avert climate catastrophe** (2021)
