...
6. **Heat transfer modelling in adsorption-based direct air capture - Validation of a 1D model and simulation of an embedded heat exchanger using geometric heat transfer distribution** (2026)
   0 citations · DAC
