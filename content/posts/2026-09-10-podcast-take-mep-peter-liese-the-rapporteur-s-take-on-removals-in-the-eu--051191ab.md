...
cover:
  image: "/images/posts/podcast-take-mep-peter-liese-the-rapporteur-s-take-on-removals-in-the-eu--051191ab.jpg"
  alt: "Podcast take: MEP Peter Liese: the Rapporteur's take on removals in the EU ETS"
  hidden: false
---

> Take on a podcast episode from **The CDR Policy Scoop**, originally published Tue, 08 Se.
> Listen: <https://shows.acast.com/the-cdr-policy-scoop/episodes/mep-peter-liese-the-rapporteurs-take-on-removals-in-the-eu>
...
Worth pairing this with the show's own prior episode on the CDR cost gap in the ETS proposal, and with the [Isometric](https://isometric.com) modeling Manhart references. The CRCF (Carbon Removals and Carbon Farming) certification link Liese endorses matters because it decides which future methods automatically become ETS-eligible — enhanced weathering, mineralization, and marine pathways all sit downstream of that question. His Namibia cement-plant anecdote — European operator, 360 days of sun, co-locating CCS and DACCS — is the clearest articulation I've heard from an MEP of why international removal credits are not just an offset flanker but a supply-side lever.
