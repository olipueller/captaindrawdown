...
>
> This is v1 of our CDR researcher census. Country and institution data now uses ORCID self-reported affiliations where available (66% of researchers), falling back to OpenAlex's "last known institution" for the rest. This is a significant improvement over v0, but some assignments may still be outdated or missing. **Your corrections make v2 better.** [Bluesky](https://bsky.app/profile/captaindrawdown.bsky.social) · [X](https://x.com/CaptainDrawdown)
...
China has **nearly three times** more CDR researchers than the United States. That's not a rounding error — it's a structural reality. And 36% of China's CDR researchers are *growing* their output, the highest rate among major countries.

## How This Compares to Lück et al.

Lück et al. tracked first-author countries for 13,366 papers. Their data shows China at 23% and the US at 19%. My data shows China at 34% and the US at 13%.
...
|---------|-----------------|-------------------|
| China | 23.0% | 33.6% |
| United States | 19.4% | 12.6% |
| United Kingdom | 5.2% | 3.6% |
| India | 4.2% | 7.2% |
| Australia | 3.8% | 1.9% |

## The Institutional Powerhouses

The top 20 institutions are dominated by Chinese academia — 17 of 20 are Chinese universities or research institutes. The Chinese Academy of Sciences alone has **1,537 CDR researchers**, more than many entire countries.
...
**China:** 34% of researchers, but a much smaller share of CDR startups in Western databases. Chinese CDR companies may be underrepresented in English-language directories — or the science-to-startup pipeline may work differently there.

**United States:** 13% of researchers, but the largest concentration of DAC companies (Climeworks US operations, Heirloom, CarbonCapture Inc., etc.). The US converts a smaller research base into more commercial activity — or attracts companies regardless of where the science originates.

**India:** 7.2% of researchers (8,153 people) and growing at 30%. But relatively few CDR companies. This is a massive untapped talent pool.
...
2. **India is the sleeping giant.** 8,153 researchers and growing fast, with almost no commercial CDR sector yet.
