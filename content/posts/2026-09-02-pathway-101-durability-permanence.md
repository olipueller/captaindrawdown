...
The life-cycle literature complicates the picture further. [Terlouw et al. (2021)](https://openalex.org/W3129603369) show in their review of CDR life-cycle assessments that upstream emissions, energy source, and end-of-life fate can materially shrink the net durable tonne, especially for pathways where the "removal" and the "storage" are decoupled in time and space. For biochar specifically, [Lehmann et al. (2021)](https://openalex.org/W4200339548) note that mean residence times vary by more than an order of magnitude depending on feedstock and production conditions — a headline "hundreds to thousands of years" figure hides a distribution that matters for pricing.

### How it plays out across pathways

The concept bites differently depending on where the carbon ends up.

For solid-sorbent Direct Air Capture with basalt mineralization, operators like [Climeworks](https://climeworks.com/) and [Heirloom](https://www.heirloomcarbon.com/) sell against a >10,000-year claim, which is why offtake prices sit in the high hundreds of dollars per tonne. The durability argument depends on the storage partner (mineralization vs. saline aquifer) more than on the capture technology; a [CarbonCapture Inc.](https://www.carboncapture.com/) or [Skytree](https://skytree.tech/) tonne is only as durable as the geology it lands in.

For bioenergy with carbon capture and storage (BECCS), the durability claim is again geologic — [Carbon America](https://www.carbonamerica.com/) is building around Class VI wells in Colorado, and [Svante's](https://www.svanteinc.com/) acquired Carbon Alpha assets target the same storage class. [Reverion](https://reverion.com/en/), by contrast, captures biogenic CO₂ but the storage question is answered downstream.

For biochar, the durability claim is inherently probabilistic and site-specific. [NetZero](https://netzero.green/en/), [Bio-Logical](https://www.bio-logical.green/), [Dark Earth Carbon](https://www.darkearthcarbon.com/), [Alcom Carbon Markets](https://alcomcm.com), [Aymium](https://aymium.com/), [Green Carbon](https://green-carbon.co.jp/), and [Carbon Remove](https://www.carbonremove.com.br/en) all pyrolyze different feedstocks under different conditions, and registries apply a decay factor (Puro.earth's methodology, for example, discounts the tonne based on H:C ratio). The agronomic meta-analysis by [Schmidt et al. (2021)](https://openalex.org/W3198220514) is often used to defend century-plus persistence, but field measurement over that horizon does not exist.

For afforestation and soil carbon, the durability claim is the weakest and buffer pools are largest. [Klim](https://www.klim.eco/) and [Grow Indigo](https://www.growindigo.co.in/) operate in regulatory and biophysical environments where a 30- to 100-year commitment is the ceiling. Buyers who need "like-for-like" durability against fossil emissions increasingly treat these as avoidance-adjacent rather than as removals for net-zero claims.
