...
cover:
  image: "/images/posts/pathway-101-mineralization.png"
  alt: "Pathway 101: Mineralization"
  hidden: false
---
...
The underlying chemistry is silicate weathering, the same process that has regulated Earth's climate over million-year timescales by [acting as a geological thermostat](https://openalex.org/W4318141507). Divalent cations — chiefly Ca²⁺ and Mg²⁺ — released from silicate minerals react with dissolved CO₂ to precipitate carbonates. In nature this is slow; the engineering problem is acceleration.
...
- **Enhanced weathering on land.** Powdered silicates are spread on agricultural soils, where they dissolve and export bicarbonate to groundwater and eventually the ocean. Modelling for the [United Kingdom suggests substantial national-scale drawdown potential](https://openalex.org/W4224322958), and [ecosystem responses to powdered rock](https://openalex.org/W3183567029) can compound the carbon effect via improved plant productivity, though the [agronomic literature on remineralizing soils](https://openalex.org/W3206540274) is older than the CDR framing.

Energy intensity, kinetics, and feedstock logistics — not chemistry — are what determine cost and net removal.

## Who's doing it

- [**44.01**](https://4401.earth) (Oman, ~168 FTE) injects dissolved CO₂ into peridotite in the Hajar Mountains; probably the largest in-situ peridotite operator.
- [**Cella Mineral Storage**](https://www.cellamineralstorage.com/) (US/Kenya) runs a comparable in-situ approach in Rift Valley basalts, partnered with several direct air capture (DAC) suppliers.
- [**CarbonCure**](https://www.carboncure.com/) (Canada, ~81 FTE) is the most widely deployed concrete-injection licensor, retrofitted into hundreds of ready-mix plants.
- [**Paebbl**](https://paebbl.com/) (Netherlands) reacts CO₂ with crushed olivine ex-situ to make a supplementary cementitious material — a bet that mineralization pays for itself via the cement market.
- [**Neustark**](https://www.neustark.com) (Switzerland) captures biogenic CO₂ from biogas plants and mineralizes it into demolition concrete aggregate, coupling a biogenic source to a waste-mineral sink.
- [**Travertine**](https://travertinetech.com/) (US) uses an electrochemical process on sulfate wastes (phosphogypsum, tailings) that co-produces sulfuric acid; a Frontier pre-purchase recipient.
- [**Arca**](https://arcaclimate.com/) (Canada) targets ultramafic mine tailings with churning rovers, aiming to slot into existing mining operations rather than build greenfield sites.
- [**Andes**](https://www.andes.bio/) (US, ~219 FTE) sits at the enhanced-weathering/soil-microbiome boundary, applying microorganisms with crop seeds to accelerate silicate weathering in the root zone — the most agronomic approach in the directory.

Smaller entrants such as [Carbonaide](https://carbonaide.com/), [CarbiCrete](https://carbicrete.com/), [Blue Planet](https://www.blueplanetsystems.com/), [C-Crete](https://ccretetech.com/), and [Anvil](https://www.anvilcarbon.com) illustrate the range of feedstocks (slag, olivine, non-carbonate rocks, ores) and formats (blocks, aggregate, binder, direct air mineralization).
