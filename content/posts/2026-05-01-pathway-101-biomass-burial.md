...
- **Thermochemical pre-treatment.** Pyrolysis, hydrothermal liquefaction (HTL), or hydrothermal carbonization (HTC) convert labile biomass into more recalcitrant forms (biochar, bio-oil, hydrochar) before storage. Reviews of these conversion routes within carbon-negative system designs are surveyed in [Yang et al. 2021](https://openalex.org/W3176278271) and [Wang et al. 2021](https://openalex.org/W3139228187).

The thermodynamic case for the pathway as one of several CDR options is laid out in [Fuhrman et al. 2023](https://openalex.org/W4323670107), which finds that diversifying across CDR approaches eases pressure on land, water, and energy budgets relative to a BECCS-heavy portfolio (see also the European BECCS assessment in [Rodríguez et al. 2021](https://openalex.org/W3153554019)).

## Who is doing it

The directory contains roughly two dozen suppliers, clustered into a few archetypes:

- [Charm Industrial](https://charmindustrial.com/) pyrolyses agricultural residues into bio-oil and injects it into EPA-regulated wells; it is the largest deliverer of CDR credits in the pathway by FTE count and by retired tonnage.
- [Vaulted Deep](https://vaulteddeep.com/) skips the pyrolysis step and slurry-injects organic waste streams (biosolids, manure, paper sludge) using oil-and-gas well technology.
- [Graphyte](https://www.graphyte.com/), backed by Breakthrough Energy, dries and compresses timber and ag residues into wrapped "Carbon Casting" blocks for shallow burial; its first facility is in Pine Bluff, Arkansas.
- [Mast Reforestation](https://www.mastreforest.com/) pairs post-wildfire reforestation with burial of fire-killed trees in engineered chambers, issuing Puro.earth CORC credits.
- [Kodama Systems](https://kodama.ai/) uses semi-autonomous forest-thinning equipment in California, burying the small-diameter waste in Nevada wood vaults.
- [Rewind](https://www.rewind.earth/) stores sawdust and offcuts in disused deep mines (DMS Georgia, 1.3 km underground) and is exploring anoxic marine basins.
- [NULIFE GreenTech](https://nulifegreentech.com/) runs the HTL route, injecting bio-oil into licensed salt caverns.
- [Cowboy Clean Fuels](https://cowboycleanfuels.com/) injects biomass into depleted Powder River Basin coalbed methane wells, where microbes generate saleable methane and the residual CO₂ adsorbs onto the coal.

It is a wide tent: feedstocks range from microalgae ([Arrhenius](https://arrhenius.com/)) to encroacher bush in Namibia ([Tivano Carbon](https://www.tivano-carbon.com/), [Carbonsate](https://www.carbonsate.com/)) to spruce logs driven into Dutch clay ([Underground Forest](https://www.undergroundforest.nl)). The defunct [Brilliant Planet](https://www.brilliantplanet.com) tried desert-grown marine algae in dry-tomb landfills before winding down, a reminder that the economics are not settled.
