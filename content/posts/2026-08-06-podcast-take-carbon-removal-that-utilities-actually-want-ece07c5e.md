...
cover:
  image: "/images/posts/podcast-take-carbon-removal-that-utilities-actually-want-ece07c5e.jpg"
  alt: "Podcast take: Carbon removal that utilities actually want"
  hidden: false
---

> Take on a podcast episode from **The Carbon Curve**, originally published Wed, 05 Au.
> Listen: <https://carboncurve.substack.com/p/carbon-removal-that-utilities-actually>
...
The Carbon Curve's Na'im Merchant hosts [Joachim Katchinoff](https://carboncurve.substack.com/p/carbon-removal-that-utilities-actually), CEO of CREW Carbon, on turning municipal wastewater treatment plants into alkalinity-enhancement sites. The episode was taped before CREW's Microsoft deal dropped, so the show notes carry the news; the conversation itself is about mechanism, MRV, and how you actually sell CDR into a regulated utility.
