...
> Take on a YouTube video from **Exomad Green**, originally posted 2026-05-01.
> Watch the source: <https://www.youtube.com/watch?v=2x4jaHMOx3M>

[Exomad Green × Supercritical: Inside the 500,000-Tonne CDR Deal](https://www.youtube.com/watch?v=2x4jaHMOx3M)
...
**Context.** Exomad operates forestry-residue biochar facilities in Concepción, Bolivia, and has been one of the [Puro.earth](https://puro.earth/) registry's larger issuers; their volume profile contrasts with the delivery-shortfall pattern [CDR.fyi has tracked across the biochar category](https://www.cdr.fyi/). Supercritical, for its part, sits in the same broker/marketplace bracket as [Patch](https://www.patch.io/) and [CEC](https://www.carbondirect.com/), but has leaned more heavily into curated biochar supply. The deal also lands in a market where SBTi's [draft Corporate Net-Zero Standard V2](https://sciencebasedtargets.org/net-zero) is pushing companies to plan removals procurement before 2030, which is the demand thesis George is implicitly underwriting. Worth noting: the conversation glosses over biomass sourcing audits and permanence assumptions, which are the open questions for any tropical-forestry-residue biochar at this scale.
