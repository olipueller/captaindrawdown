...
cover:
  image: "/images/posts/podcast-take-taking-stock-the-state-of-cdr-fireside-chat-with-oliver-gede-4ec6c2b6.jpg"
  alt: "Podcast take: Taking Stock: The State of CDR - Fireside Chat with Oliver Geden"
  hidden: false
---

> Take on a podcast episode from **The CDR Policy Scoop**, originally published Mon, 08 Ju.
> Listen: <https://shows.acast.com/the-cdr-policy-scoop/episodes/taking-stock-the-state-of-cdr-fireside-chat-with-oliver-gede>
...
Sebastian Manhart interviews Oliver Geden (SWP, IPCC WG3 Vice Chair, State of CDR co-author) [live at NEP Summit Brussels](https://shows.acast.com/the-cdr-policy-scoop/episodes/taking-stock-the-state-of-cdr-fireside-chat-with-oliver-gede), recorded the week the third State of CDR report dropped. Thirty minutes covering policy sequencing (foundational → supply → demand), the gap between net zero pledges and actual CDR planning, EU pillar architecture, and how the Iran conflict scrambles climate attention.
...
For context on the underlying report, see the [Negative Emissions Platform](https://negativeemissionsplatform.eu/) which hosted the event, and Geden's home institution [SWP](https://www.swp-berlin.org/). On the EU ETS integration question specifically, Eve Tamme and Sebastian have covered the Commission's expected end-of-year package across earlier [CDR Policy Scoop](https://shows.acast.com/the-cdr-policy-scoop) episodes — this one is the high-altitude companion piece. The Saudi modeling detail (60% residual emissions by 2060, balance via direct air capture with storage) is the kind of number worth filing away when sizing non-OECD demand scenarios.
