...
cover:
  image: /images/posts/20260331-04.png
---
...
Current global CDR market volume is roughly 10 million tonnes per year across all pathways — forests, biochar, direct air capture, [enhanced weathering](/posts/what-is-enhanced-weathering/), BECCS.
...
1. **Redesign wastewater treatment systems** at cement and steel facilities to maximize alkalinity contact time with CO₂ (either atmospheric or concentrated process gas)
2. **Develop MRV protocols** that can verify and credit the resulting mineral carbonation
3. **Test at scale** — several cement producers are already experimenting with carbonation-curing for concrete; the wastewater pathway is a logical extension
4. **Policy integration** — getting this recognized under carbon markets or regulatory frameworks as legitimate CDR
...
*Source: Alkaline wastewater from steel and cement production — CO₂ sequestration research, Environmental Science & Technology Letters, [doi.org/hbvb57](https://doi.org/hbvb57)*
