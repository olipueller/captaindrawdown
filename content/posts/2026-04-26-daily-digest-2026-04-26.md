...
- Ireland Has Major CDR Potential—But Must Act Fast, Says New Coalition
- [Microsoft halts CDR buying — 90% of the market just left the table](/posts/if-microsoft-is-re-evaluating-so-should-we/)
- Isometric Extends Certification to Low-Carbon Materials via New EACs
- Biomass carbon removal can scale durably—if the rules are written right
