...
Humanity emits roughly **37.4 billion tonnes of CO₂ per year** from fossil fuels ([Global Carbon Budget, 2024](https://globalcarbonbudget.org/fossil-fuel-co2-emissions-increase-again-in-2024/)). The IPCC says we need to remove **5–16 billion tonnes per year by 2050** on top of aggressive emissions cuts ([IPCC AR6 WGIII, 2022](https://www.ipcc.ch/report/ar6/wg3/downloads/outreach/IPCC_AR6_WGIII_Factsheet_CDR.pdf)). Afforestation and reforestation can contribute meaningfully — the IPCC estimates a technical potential of **0.5–10.1 GtCO₂/yr** by 2050, with median estimates around 3.9 GtCO₂/yr ([IPCC AR6 WGIII, Ch. 7](https://www.wri.org/insights/how-effective-land-removing-carbon-pollution-ipcc-weighs)) — but they can't do it alone.

Here's why:

**Land competition.** Growing enough trees to remove billions of tonnes of CO₂ requires *enormous* amounts of land — land that's also needed for food production, biodiversity, and, well, the people who already live there. A 2024 study in *Nature Climate Change* found that when accounting for implementation costs and land-use competition, realistic reforestation potential is significantly constrained ([Mo et al., *Nature Climate Change*, 2024](https://www.nature.com/articles/s41558-024-02068-1)). A separate analysis limiting negative impacts on biodiversity and food security put the maximum at about 3.8 GtCO₂/yr by 2050 ([Deprez et al., via *npj Climate Action*, 2026](https://www.nature.com/articles/s44168-026-00335-9)).

**Permanence.** Trees burn. They die. They decompose. A forest planted today could release its stored carbon back into the atmosphere in a wildfire decades from now. The 2023 Canadian wildfire season released an estimated 480 megatonnes of carbon — equivalent to roughly 1,760 Mt CO₂ — making it the fourth-largest emitter globally that year, behind only China, the US, and India ([Copernicus/CAMS, 2023](https://atmosphere.copernicus.eu/2023-year-intense-global-wildfire-activity); [Walker et al., *Nature*, 2024](https://www.nature.com/articles/s41586-024-07878-z)). That's not a theoretical risk; it's already happening.
...
- **Biochar:** Heating biomass in low-oxygen conditions creates a stable carbon-rich material that can persist in soil for hundreds to thousands of years ([Frontiers in Soil Science, 2024](https://www.frontiersin.org/journals/soil-science/articles/10.3389/fsoil.2024.1376159/full)). It also improves soil fertility. Win-win.

- **Ocean alkalinity enhancement (OAE):** Adding alkaline minerals to the ocean to increase its capacity to absorb CO₂. The ocean already absorbs about 25–30% of our emissions ([NOAA](https://www.noaa.gov/education/resource-collections/ocean-coasts/ocean-acidification); [Global Carbon Project via Carbon Brief](https://www.carbonbrief.org/guest-post-the-oceans-are-absorbing-more-carbon-than-previously-thought/)) — OAE helps it do more.
...
1. Global Carbon Budget (2024). "Fossil fuel CO₂ emissions increase again in 2024." [globalcarbonbudget.org](https://globalcarbonbudget.org/fossil-fuel-co2-emissions-increase-again-in-2024/)
...
3. World Resources Institute. "How Effective Is Land At Removing Carbon Pollution? The IPCC Weighs In." [wri.org](https://www.wri.org/insights/how-effective-land-removing-carbon-pollution-ipcc-weighs)
4. Mo, L. et al. (2024). "Cost-effectiveness of natural forest regeneration and plantations for climate mitigation." *Nature Climate Change*. [doi:10.1038/s41558-024-02068-1](https://www.nature.com/articles/s41558-024-02068-1)
