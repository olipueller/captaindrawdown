...
draft: false
cover:
  image: "/images/posts/20260401-03.png"
  alt: "remove CDR Accelerator Is Coming to Latin America"
  relative: false
---

[remove](https://remove.global/), the European CDR accelerator, is expanding to Latin America. This is genuinely good news — and it's been a while coming.
...
The full program runs eight months. The funding comes from the [Milkywire Climate Transformation Fund](https://www.milkywire.com/ctf), which has been a consistent backer of CDR ecosystem development.
...
**[Enhanced rock weathering](/posts/what-is-enhanced-weathering/) (ERW):** Tropical and subtropical soils tend to be more acidic and more mineralogically active than temperate soils — which means faster weathering reactions and more efficient carbon uptake. Brazil's cerrado region and parts of Colombia have geology and soil conditions that researchers have flagged as highly suitable for ERW deployment.
...
Interested parties can register at [remove.global/latam-accelerator](https://remove.global/latam-accelerator).

---

*Source: [Carbon Herald](https://carbonherald.com/remove-will-soon-offer-support-to-cdr-startups-in-latin-america/)*
...
- [Biochar + Basalt: Wageningen Shows Co-Deployment Changes the Weathering Game](/posts/enhanced-weathering-biochar-co-deployment/)
