...
cover:
  image: "/images/posts/podcast-take-iso-sbti-and-the-lcaw-verdict-on-corporate-net-zero-with-kay-35dac47e.jpg"
  alt: "Podcast take: ISO, SBTi, and the LCAW Verdict on Corporate Net Zero - with Kaya Axelsson"
  hidden: false
---

> Take on a podcast episode from **The CDR Policy Scoop**, originally published Tue, 30 Ju.
> Listen: <https://shows.acast.com/the-cdr-policy-scoop/episodes/iso-sbti-and-the-lcaw-verdict-on-corporate-net-zero-with-kay>
...
Sebastian Manhart and Eve Tamme host [Kaya Axelsson](https://shows.acast.com/the-cdr-policy-scoop/episodes/iso-sbti-and-the-lcaw-verdict-on-corporate-net-zero-with-kay) of Oxford Net Zero one week after the simultaneous 22 June launch of the ISO Net Zero draft standard and SBTi Corporate Net Zero Standard v2. Axelsson worked inside both processes for three years, and the episode is essentially her post-mortem: what converged, what didn't, and where the corporate demand signal for durable removals actually lands.
...
For context on how this lands in the buyer market, see prior CDR.fyi coverage of [SBTi](https://www.cdr.fyi/) demand-side dynamics and the ongoing Frontier/Stripe offtake structures that already assume pre-2035 procurement. Robert Höglund has been on this podcast previously making the same 2035-is-too-late argument Axelsson echoes here. The ISO draft is in a 12-week public consultation via national standards bodies — the removals section is one place practitioner comment could actually move text.
