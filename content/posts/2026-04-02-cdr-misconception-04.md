...
| Credit Type | Permanence | Measurability | Typical Quality |
|---|---|---|---|
| REDD+ (avoided deforestation) | Fragile (decades) | Poor | Variable / often poor |
| Cookstove offsets | N/A (avoidance) | Moderate | Mixed |
| Soil carbon | Decades | Moderate | Improving |
| Biochar | Centuries | Good | Generally solid |
| [Enhanced weathering](/posts/what-is-enhanced-weathering/) | Millennia | Improving | Emerging but rigorous |
| Direct Air Capture + storage | Geological | Excellent | High |
