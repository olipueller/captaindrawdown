...
One-third of dabblers are increasing their CDR work. They haven't committed yet, but they're heading that direction. The entry ramp into CDR still runs through dabbling — nobody wakes up and devotes their career to [enhanced weathering](/posts/what-is-enhanced-weathering/). They write one paper, then two, then five.
...
1. **Our core is smaller but more real.** 10,163 truly committed researchers beats 20,600 inflated researchers. Better to know what we actually have.

2. **The growth trajectory is steady, not explosive.** 24,316 growing researchers = 34% of the current cohort. That's not a boom, but it's baseline growth. More people are entering CDR than leaving.
...
1. **The field is real but still small.** 80,382 researchers isn't nothing — that's enough to sustain an emerging field. But it's not enough for gigaton-scale deployment. You need another 5–10× more researchers in MRV, deployment, and systems engineering.

2. **Dabblers matter more than we thought.** 14,242 growing dabblers represent the entry ramp. Strengthen that ramp — more funding opportunities, CDR PhD positions, industry partnerships — and you accelerate the pipeline from dabbler → part-time → committed.
...
*Data from the [CDR Researcher Census](/cdr-researcher-census/). V2 uses LLM-based classification; please flag edge cases or misclassifications on [Bluesky](https://bsky.app/profile/captaindrawdown.bsky.social) or [X](https://x.com/CaptainDrawdown).*
...
- [What Is Enhanced Weathering? A Simple Explanation](/posts/what-is-enhanced-weathering/)
