...
cover:
  image: "/images/posts/yt-take-why-concrete-is-the-world-s-biggest-carbon-trap-hltbvu1t.jpg"
  alt: "YouTube take: Why Concrete Is the World’s Biggest Carbon Trap"
  hidden: false
---

> Take on a YouTube video from **The Odd Vault**, originally posted 2026-08-31.
> Watch the source: <https://www.youtube.com/watch?v=hltbVu1tsQM>
...
For CDR practitioners, this sits in the crowded "low-carbon and CO2-utilizing cement" bucket alongside [CarbonCure](https://www.carboncure.com/), Solidia, Prometheus Materials, [Sublime Systems](https://sublime-systems.com/), and [Brimstone](https://www.brimstone.com/). Most of these are avoided-emissions plays with a small mineralization tail; only a few (Partanna, some olivine-based approaches) credibly argue net-negative at scale. Frontier and other buyers have funded mineralization-in-cement work; the LCA (lifecycle assessment) methodology fight over what counts as durable storage versus avoided emissions is where the actual policy action is. The video doesn't touch any of this.
