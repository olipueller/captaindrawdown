...
> Take on a YouTube video from **Nature Tech Collective**, originally posted 2026-05-01.
> Watch the source: <https://www.youtube.com/watch?v=Qpq2v2HRhXw>

[Watch on YouTube](https://www.youtube.com/watch?v=Qpq2v2HRhXw)
...
For context, Planetary has been running OAE trials off Halifax for several years and is one of a small cohort — alongside [Ebb Carbon](https://www.ebbcarbon.com/), Vesta, and Gigablue — pushing different OAE flavors (electrochemical, coastal mineral, open ocean). The science backdrop Burt gestures at is laid out more rigorously in the [OAE state-of-the-planet review by Oschlies et al.](https://sp.copernicus.org/articles/2-oae2023/index.html) and in [Ho et al. on MRV challenges](https://www.frontiersin.org/journals/climate/articles/10.3389/fclim.2023.1206943/full). If you've read those, this webinar will not add much on the science side; its value is hearing how an operator currently frames the pitch to a nature-tech audience that isn't CDR-native.
