...
- **2026-04-19** — url added from cdr.fyi supplier page: https://www.kanadevia.com/company/outline.html ([source](https://www.cdr.fyi/supplier/kanadevia-corporation))
- **2026-04-19** — discovered via: cdrfyi ([source](https://www.cdr.fyi/supplier/kanadevia-corporation))
- **** — merged duplicate: Kanadevia Corporation (slug=kanadevia-corporation)
- **2026-04-19** — refresh: coresignal
- **2026-04-19** — reclassified: pathway=BECCS focus=supplier liveliness=🟢 Active ([source](https://en.wikipedia.org/wiki/Kanadevia))
- **2026-04-19** — url added from cdr.fyi supplier page: https://www.kanadevia.com/english/ ([source](https://www.cdr.fyi/supplier/kanadevia))
- **2026-04-19** — discovered via: cdrfyi ([source](https://www.cdr.fyi/supplier/kanadevia))
