...
- **2026-04-19** — reclassified: pathway=Biochar focus=supplier liveliness=🟢 Active ([source](https://esgnews.com/altitude-secures-165000-tonne-biochar-carbon-removal-offtake-from-argentina-facilities/))
- **2026-04-19** — reclassified: pathway=Afforestation focus=ecosystem liveliness=🟢 Active ([source](https://www.ecogaia.earth/))
- **2026-04-19** — discovered via: cdrfyi ([source](https://www.cdr.fyi/marketplace/eco2gala))
- **** — merged duplicate: eCO2Gaia (slug=eco2gaia)
