...
- **2026-04-19** — reclassified: pathway=BECCS focus=division liveliness=🟢 Active ([source](https://www.gaia-ccs.dk/))
- **2026-04-19** — url added from cdr.fyi supplier page: https://www.gaia-ccs.dk/ ([source](https://www.cdr.fyi/supplier/gaia-projectco))
- **2026-04-19** — reclassified: pathway=BECCS focus=division liveliness=🟢 Active ([source](https://www.gaia-ccs.dk/press-article-july-7/))
- **2026-04-19** — discovered via: cdrfyi ([source](https://www.cdr.fyi/supplier/gaia-projectco))
- **** — merged duplicate: Gaia ProjectCo (slug=gaia-projectco)
- **2026-04-19** — refresh: screenshot, liveliness
- **2026-04-19** — liveliness: 🟢 Active → 🟠 Suspect ([source](https://www.archyde.com/big-techs-carbon-removal-gamble-is-it-enough/))
