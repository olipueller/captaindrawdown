...
<table class="company-facts">
  ...
  <tr><th>LinkedIn</th><td><a href="https://www.linkedin.com/company/imflorestal/" target="_blank" rel="noopener">imflorestal — 1,575 followers</a></td></tr>
...
Ibero Massa Florestal (IMF) is a Portuguese biochar producer based in Oliveira de Azeméis that transforms forest biomass through slow pyrolysis into Ecochar (agricultural biochar) and Carvão Zero (household charcoal), with an installed capacity of 5,000 tonnes/year. The company is certified under EBC, GLOBAL C-SINK, FSC, PEFC, DIN Plus, SURE and ISO 9001, and partners with Carbonfuture to sell biochar carbon removal credits.
...
- **2026-07-25** — news mention: Ibero Massa Florestal: 📢 New publication I am pleased to share our newly published Short Communicati ([source](https://www.linkedin.com/company/imflorestal/#post-74defa9144f4))
...
- **2026-07-19** — news mention: Impacts of enhanced rock weathering on soil sponge function: a global synthesis of soil physical and ([source](https://cdrxiv.org/preprint/527))
- **2026-06-15** — liveliness: 🟢 Active → 🔴 Likely Dead ([source](https://tracxn.com/d/companies/ibero/__BreM4r32ZvwnH0EXNQ0tHL-VfrWWt4samxIgka68OBw))
...
- **2026-04-19** — reclassified: pathway=Biochar focus=supplier liveliness=🟢 Active ([source](https://en.imflorestal.com/))
- **2026-04-19** — discovered via: cdrfyi ([source](https://www.cdr.fyi/supplier/ibero-massa-florestal))
- **** — merged duplicate: Ibero Massa Florestal, S.A. (slug=ibero-massa-florestal-sa)
- **2026-04-19** — reclassified: pathway=Biochar focus=supplier liveliness=🟢 Active ([source](https://en.imflorestal.com/))
- **2026-04-19** — refresh: coresignal, liveliness
