...
layout: "single"
type: "directory"
description: "Carbon Plus operates the Bukit Selar Carbon Station in Kelantan, Malaysia, converting biomass (palm kernel shells, bamboo, EFB, wood waste) into biochar via high-temperature gasification (>850°C) for"
...
- **2026-04-19** — reclassified: pathway=Biochar focus=supplier liveliness=🟢 Active ([source](https://carbon-plus.org/))
